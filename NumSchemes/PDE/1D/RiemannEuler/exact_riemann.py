...
class ExactRiemann:
    ...
    def print_info(self, filename):
        ...
        result_str += f'|$W_L^*$: | {self.rhoL_star:10.3f} | {self.u_star:10.3f} | {self.p_star:10.3f} | {self.aL_star:10.3f}|\n'
        result_str += f'|$W_R^*$: | {self.rhoR_star:10.3f} | {self.u_star:10.3f} | {self.p_star:10.3f} | {self.aR_star:10.3f}|\n'
